...
本章将系统讲解 Organization 的创建与配置、Team 的层级设计，以及 SAML SSO 的集成方法。关于 Organization 内的角色权限细节，参见 [权限与角色体系](02-权限与角色体系.md)；关于企业级统一治理方案，参见 [企业级功能 GHE](04-企业级功能-GHE.md)。
...
所有 Team 的创建、删除、成员变更都会记录在 Organization 的 Audit Log 中。参见 [审计日志与合规](03-审计日志与合规.md) 了解如何查询和导出审计日志。
