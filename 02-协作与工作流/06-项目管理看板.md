...
> [!NOTE]
> Projects V2 可以跨仓库聚合 Issue 和 PR。你可以在一个看板中同时管理来自多个仓库的工作项，这对于需要协调多个服务的团队来说非常实用。它也可以直接关联 [Issue 完整指南](01-Issue-完整指南.md) 中创建的 Issue 和 [PR 完整生命周期](03-PR-完整生命周期.md) 中创建的 PR。
...
将 Projects V2 的自定义字段与 [标签与里程碑](02-标签与里程碑.md) 体系结合使用：
