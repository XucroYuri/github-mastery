...
本章将深入对比三种主流分支策略，帮助你根据团队规模、发布节奏和项目特点做出合适的选择。建议先回顾 [分支基础](../01-基础操作/04-分支基础.md) 中的分支操作知识。
...
开源项目通常使用 Forking Workflow + GitHub Flow 的组合。项目维护者直接在仓库内使用 GitHub Flow 开发，外部贡献者通过 Fork + PR 提交代码。具体参见 [PR 完整生命周期](03-PR-完整生命周期.md) 中的 Fork 相关内容。
